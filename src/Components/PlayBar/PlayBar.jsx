...
import drunk_in_love from '../../assets/music/Drunk In Love (Remix).mp3'
import Starboy from '../../assets/music/01. Starboy (Ft. Daft Punk).mp3'
...
const PlayBar = () => {
    ...
    const song = (rawsong) => {
        ...
        let song = rawsong.replaceAll(" ", '%20')
        return song
    } 
    ...
    const songlist = [

        {
            artist: 'The Weeknd',
            title: 'Drunk In Love',
            song: song(drunk_in_love)
        },
        {
            artist: 'The Weeknd',
            title: '01. Starboy (Ft. Daft Punk)',
            song: song(Starboy)
        },
        {
            artist: 'The Weeknd',
    ...
    const [toPlay, setToPlay] = useState(songlist[0].song)
    ...
    const play = (song) => {
        ...
        let audio = new Audio(drunk_in_love)
        console.log(drunk_in_love)
        audio.play()
        ...
        <div className="playbar">
            ...
            <div className='controls'>
                <div className='buttons'>
                    ...
                    <div className='play_n_pause' onClick={play()}>
                ...
                <div className='progress'>
                    ...
                    defaultValue="0"
                    />
                    <div id='song_progress_keeper'>
                        <div className='song_progress_keeper_move onplay'></div>
                    </div>
                    <div id='song_progress_bar'></div>
                </div>
            </div>
            <div className='volume onplay'>
                <div>
