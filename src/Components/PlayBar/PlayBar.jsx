...
const PlayBar = ({
  ...
  const handleSongProgress = (e) => {
    ...
    let song_progress_counter = document.getElementById(
      "song_progress_counter"
    );
          ...
          <div className="playbar_container">
            ...
            <div className="controls">
              <div className="buttons">
                <div
                  className={isOnShuffle ? "shuffle active" : "shuffle"}
                  onClick={doShuffle}
                >
                  <svg
                    width="16"
                ...
                <div className="play_n_pause" onClick={playPause}>
                  <svg
                    className={isPlaying ? "playicon" : "playicon show"}
                    width="9"
                    height="10"
                    viewBox="0 0 9 10"
                    fill="none"
                  ...
                  <svg
                    className={isPlaying ? "pauseicon show" : "pauseicon"}
                    width="8"
                    height="9"
                    viewBox="0 0 8 9"
                    fill="none"
                ...
                >
                  {repeatType === "no_repeat" ? (
                    ...
                    >
                      <path
                        d="M2.60659 11.4533C2.47992 11.4533 2.35325 11.4067 2.25325 11.3067C1.33992 10.3867 0.833252 9.17335 0.833252 7.88668C0.833252 5.21335 2.99992 3.04001 5.66659 3.04001L9.71325 3.05335L8.98659 2.36001C8.78659 2.16668 8.77992 1.85335 8.97325 1.65335C9.16659 1.45335 9.47992 1.44668 9.67992 1.64001L11.3066 3.20001C11.4533 3.34001 11.4999 3.56001 11.4266 3.74668C11.3533 3.93335 11.1666 4.06001 10.9599 4.06001L5.66659 4.04668C3.55325 4.04668 1.83325 5.77335 1.83325 7.89335C1.83325 8.91335 2.23325 9.88001 2.95992 10.6067C3.15325 10.8 3.15325 11.12 2.95992 11.3133C2.85992 11.4067 2.73325 11.4533 2.60659 11.4533Z"
                        fill="white"
                      />
                      <path
                        d="M6.6666 14.5C6.53993 14.5 6.41993 14.4534 6.31993 14.36L4.69327 12.8C4.5466 12.66 4.49993 12.44 4.57327 12.2534C4.65327 12.0667 4.83993 11.9667 5.03993 11.94L10.3399 11.9534C12.4533 11.9534 14.1733 10.2267 14.1733 8.10669C14.1733 7.08669 13.7733 6.12002 13.0466 5.39335C12.8533 5.20002 12.8533 4.88002 13.0466 4.68669C13.2399 4.49335 13.5599 4.49335 13.7533 4.68669C14.6666 5.60669 15.1733 6.82002 15.1733 8.10669C15.1733 10.78 13.0066 12.9534 10.3399 12.9534L6.29327 12.94L7.01993 13.6334C7.21993 13.8267 7.2266 14.14 7.03327 14.34C6.9266 14.4467 6.79993 14.5 6.6666 14.5Z"
                        fill="white"
                      />
                      <path
                        d="M7.842 10.06C7.498 10.06 7.206 9.97 6.966 9.79C6.73 9.606 6.55 9.352 6.426 9.028C6.302 8.7 6.24 8.324 6.24 7.9C6.24 7.472 6.302 7.096 6.426 6.772C6.55 6.448 6.73 6.196 6.966 6.016C7.206 5.832 7.498 5.74 7.842 5.74C8.186 5.74 8.476 5.832 8.712 6.016C8.952 6.196 9.134 6.448 9.258 6.772C9.382 7.096 9.444 7.472 9.444 7.9C9.444 8.324 9.382 8.7 9.258 9.028C9.134 9.352 8.952 9.606 8.712 9.79C8.476 9.97 8.186 10.06 7.842 10.06ZM7.842 9.34C8.01 9.34 8.154 9.288 8.274 9.184C8.398 9.076 8.494 8.916 8.562 8.704C8.63 8.488 8.664 8.22 8.664 7.9C8.664 7.576 8.63 7.308 8.562 7.096C8.494 6.884 8.398 6.726 8.274 6.622C8.154 6.514 8.01 6.46 7.842 6.46C7.678 6.46 7.534 6.514 7.41 6.622C7.286 6.726 7.19 6.884 7.122 7.096C7.054 7.308 7.02 7.576 7.02 7.9C7.02 8.22 7.054 8.488 7.122 8.704C7.19 8.916 7.286 9.076 7.41 9.184C7.534 9.288 7.678 9.34 7.842 9.34Z"
                        fill="white"
                      />
                    </svg>
                  ) : repeatType === "repeat_once" ? (
              ...
              <div className="progress_container">
                <p>
                  {currentSong.progress
                    ? sToTime(currentSong.currentTime)
                    : "00:00"}
                </p>
                <div className="progress">
                  ...
                  >
                    <div
                      className={
                        isPlaying
                          ? "song_progress_keeper_move onplay"
                ...
                <p>
                  {currentSong.length ? sToTime(currentSong.length) : "00:00"}
                </p>
              </div>
            </div>
        ...
        <div className="signin_banner">
          <div className="signin_banner_container">
            <div className="signin_banner_text">
              <p>Muscia Preview</p>
              <p>
                Sign up to show unlimited songs and podcasts with occasional
