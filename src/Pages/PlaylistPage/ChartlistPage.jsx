...
import ChartRank from '../../Components/ChartRank/ChartRank';
    ...
    return ( 
        <div className="playlistpage">
            ...
            <div className='playlistpage_container'>
                ...
                <div className='chartList_last_part'>
                    <div className='ranking'>
                        <ChartRank ranknumber={1}/>
                        <ChartRank ranknumber={2}/>
                        <ChartRank ranknumber={3}/>
                        <ChartRank ranknumber={4}/>
                        <ChartRank ranknumber={5}/>
                        <ChartRank ranknumber={6}/>
                        <ChartRank ranknumber={7}/>
